    	...
    	<div class="c8 shadow" style="background: white;  padding:20px;">
    		<div class="c5 cardLeft">
    			...
    			<div style="height:auto;width:100%;font-family: NeutraText BookItalic;">
	            	<div style="height:auto;width:100%;font-family: NeutraText BookItalic; text-align:center">
				        <h2>Thanks for contacting us!</h2>
						<h2>We will get back to you ASAP</h2>
						<span class="green"><a href="index.php" title="MOS Creative | Home">Back to Home page</a></span>               
		            </div>
	       		</div>
    		</div>
